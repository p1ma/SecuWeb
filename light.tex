...
\begin{block}{Présentation}
	\begin{itemize}
		\item Projet open source \href{https://github.com/zaproxy/zaproxy/}{\beamergotobutton{https://github.com/zaproxy/zaproxy}}
...
\begin{center}
	...
	activate=pageopen,
	addresource=videos/OWASP_INJECTION.mp4,
	flashvars={source=videos/OWASP_INJECTION.mp4}
	]{}{VPlayer.swf}	
\end{center} 
\end{frame}
...
\begin{frame}{OWASP ZAP - Session hijacking (XSS)}
	\begin{center}
		...
		height=0.5\linewidth,
		activate=pageopen,
		addresource=videos/XSS_ADMIN.mp4,
		flashvars={source=videos/XSS_ADMIN.mp4}
		]{}{VPlayer.swf}	
	\end{center} 
\end{frame}
...
\begin{frame}{OWASP ZAP - Revue de code}
	\begin{center}
		...
		height=0.5\linewidth,
		activate=pageopen,
		addresource=videos/OWASP-RevueCode.mp4,
		flashvars={source=videos/OWASP-RevueCode.mp4}
		]{}{VPlayer.swf}	
	\end{center} 
\end{frame}
...
\begin{block}{Présentation}
	\begin{itemize}
		\item Projet open source \href{http://w3af.org/}{\beamergotobutton{http://w3af.org/}}
...
\begin{frame}{W3AF - Audit}
	\begin{center}
		...
		height=0.5\linewidth,
		activate=pageopen,
		addresource=videos/W3AF_AUDIT.mp4,
		flashvars={source=videos/W3AF_AUDIT.mp4}
		]{}{VPlayer.swf}	
	\end{center} 
\end{frame}
...
\begin{frame}{Références}
	...
	\\Ressources: \\
	\small{\url{http://www.dvwa.co.uk/}}
	\\Logiciels: \\
	\small{\url{https://github.com/zaproxy/zaproxy/}}
	\small{\url{http://w3af.org/}}
	\\GitHub: \\
	\small{\url{https://github.com/p1ma/SecuWeb}}
